    ...
    <section className='mt-16 w-full max-w-xl'>
          ...
          {allArticle.map((item,index)=>(
            ...
            >
              <div className='copy_btn' onClick={()=> handleCopy(item.url)}>
                ...
                <p className='fex-1 font-satoshi text-blue-700 font-medium text-sm truncate'>
                  {item.url}
                </p>
            </div>
          ))}
      ...
      <div className='my-10 max-w-full flex justify-center items-center'>
        {isFetching ? (
          ...
          <p className='font-inter font-bold text-black text-center'>well,that wasn't  what we anticipated....
          <br/>
